...
> ### How to Get Started
> * Check out the [Contributing Guidelines](https://github.com/Rexzy67/RRC/blob/main/docs/CONTRIBUTING.md) for step-by-step guidance on submitting pull requests and reporting bugs.
> * Please make sure to review and follow our [Code of Conduct](https://github.com/Rexzy67/RRC/blob/main/docs/CODE_OF_CONDUCT.md) to keep this Script community welcoming and inclusive.
> 
> ### Ways You Can Help
